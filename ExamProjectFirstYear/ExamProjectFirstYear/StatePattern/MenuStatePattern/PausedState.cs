...
namespace ExamProjectFirstYear.MenuStatePattern
{
    ...
    public class PausedState : IMenuHandlerState
    {
        ...
        public void Enter(IEntity entity)
        {
            ...
            pausedHeading = GameWorld.Instance.Content.Load<SpriteFont>("JournalHeading");
            pausedText = GameWorld.Instance.Content.Load<SpriteFont>("JournalText");
            ...
            pausedHeadingPosition = new Vector2(GameWorld.Instance.GraphicsDevice.Viewport.Width / 2,
                                               (GameWorld.Instance.GraphicsDevice.Viewport.Height / 2) - 100);
            pausedTextPosition = new Vector2(GameWorld.Instance.GraphicsDevice.Viewport.Width / 2,
                                            (GameWorld.Instance.GraphicsDevice.Viewport.Height / 2) + 100);
