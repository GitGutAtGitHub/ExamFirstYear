...
namespace ExamProjectFirstYear.MenuStatePattern
{
    ...
    /// </summary>
    public class StartState : IMenuHandlerState
    {
        #region Fields
        ...
        public void Enter(IEntity entity)
        {
            ...
            startText = GameWorld.Instance.Content.Load<SpriteFont>("JournalHeading");

            startTextPosition = new Vector2(GameWorld.Instance.GraphicsDevice.Viewport.Width / 2,
