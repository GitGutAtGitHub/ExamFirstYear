...
namespace ExamProjectFirstYear.MenuStatePattern
{
    ...
    public class LoadingState : IMenuHandlerState
    {
        ...
        public void Enter(IEntity entity)
        {
            ...
            loadingHeading = GameWorld.Instance.Content.Load<SpriteFont>("JournalHeading");
            ...
            loadingHeadingPosition = new Vector2(GameWorld.Instance.GraphicsDevice.Viewport.Width / 2,
                                                 GameWorld.Instance.GraphicsDevice.Viewport.Height / 2);
